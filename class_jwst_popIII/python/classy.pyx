...
cdef class Class:
    ...
    def get_current_derived_parameters(self, names):
        ...
        for name in names:
            ...
            elif name == 'jwst_popIII_tau':
                value = self.th.jwst_popIII_tau
            elif name == 'z_reio':
