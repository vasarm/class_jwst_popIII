...
enum reionization_parametrization {
                                   ...
                                   reio_jwst_popIII /**< reionization derived using JWST */
};
...
struct thermodynamics
{
  ...
  // != Martin
  /** parameters for reio_jwst_popIII */
  double reio_jwst_popIII_logMvcut; 
  double reio_jwst_popIII_fesc; 
  double reio_jwst_popIII_a; 
  double reio_jwst_popIII_b; 
  double reio_jwst_popIII_d; 
  double reio_jwst_popIII_zpop; 
  
  FileName reio_jwst_popIII_Phi_UV_file; /**< path to datUV table file */
  int reio_jwst_popIII_Phi_UV_n0;
  int reio_jwst_popIII_Phi_UV_n1;
  int reio_jwst_popIII_Phi_UV_n2;
  double * reio_jwst_popIII_Phi_table;
  struct trilinear_grid reio_jwst_popIII_Phi_grid;
  ...
  int index_th_x_HI;          /**< neutral hydrogen fraction \f$ x_{\rm HI}(z) = 1 - x_{\rm HII}(z) \f$ from JWST pop-III ODE (only allocated for reio_jwst_popIII) */
  ...
  double jwst_popIII_tau; /**< photon optical depth kappa integrated from z=0 to z=zpop (reio_jwst_popIII only) */

  // != Martin
  /** x_H(z) interpolation table for jwst_popIII  */
  double * reio_jwst_z_table;
  double * reio_jwst_x_table;      /**< x_HII(z): ionized fraction from ODE */
  double * reio_jwst_ddx_table;

  int reio_jwst_table_size;
...
extern "C" {
  ...
  double thermodynamics_jwst_popiii_ndot_ion_over_n_h(double z,
                                                       struct background * pba,
                                                       struct thermodynamics * pth,
                                                       double * pvecback);
  ...
  int thermodynamics_jwst_popIII_ndot_ion_over_n_H(double z,
  ...
  int thermodynamics_jwst_popIII_calculate_x_H(struct precision * ppr,
                                               struct background * pba,
                                               struct thermodynamics * pth,
                                               ErrorMsg errmsg);
