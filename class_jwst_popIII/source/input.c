...
int input_read_parameters_general(struct file_content * pfc,
  ...
  if (flag1 == _TRUE_){
    ...
    else if (strcmp(string1,"reio_jwst_popIII") == 0){
      pth->reio_parametrization = reio_jwst_popIII;
    }
    else{
      class_stop(errmsg,
                 "You specified 'reio_parametrization' as '%s'. It has to be one of {'reio_none','reio_camb','reio_bins_tanh','reio_half_tanh','reio_many_tanh','reio_inter','reio_jwst_popIII'}.",string1);
    }
  }
  ...
  /** 8.e) Reionization parameters if reio_parametrization=reio_jwst_popIII */
  case reio_jwst_popIII:
    class_read_string("Phi_UV_file", pth->reio_jwst_popIII_Phi_UV_file);
    class_read_double("reio_jwst_popIII_logMvcut", pth->reio_jwst_popIII_logMvcut);
    class_read_double("reio_jwst_popIII_fesc",     pth->reio_jwst_popIII_fesc);
    class_read_double("reio_jwst_popIII_a",        pth->reio_jwst_popIII_a);
    class_read_double("reio_jwst_popIII_b",        pth->reio_jwst_popIII_b);
    class_read_double("reio_jwst_popIII_d",        pth->reio_jwst_popIII_d);
    class_read_double("reio_jwst_popIII_zpop",     pth->reio_jwst_popIII_zpop);
    break;
